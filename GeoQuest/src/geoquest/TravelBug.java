...
public class TravelBug implements Card, Comparable<TravelBug>
{
   ...
   static final Map<String, TravelBug> BUGS = new TreeMap<String, TravelBug>();
   static { populate(); }
   ...
   private static void printCard (final PrintWriter out, final TravelBug bug,
                                  final int i)
   {
      if (i % PER_PAGE == 0) out.println ("<table cellspacing=10>\n");
      if (i % PER_ROW == 0) out.println ("<tr>");

      //out.print ("  <td bgcolor=" + COLOR + " align=center height=90 width=90>");
      out.print ("<td style=\"" +
                 " background-image: url(images/rules/TravelBug.png); " +
                 " font-family: arial;" +
                 " font-size: small;" +
                 " color: black;" +
                 "\" align=center height=70 width=113>");
