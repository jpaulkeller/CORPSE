...
public class Equipment implements Card, Comparable<Equipment>
{
   ...
   {
      add("Backpack", "Provides 4 extra equipment slots, but you can't move more than 5 per turn.", null, "Through Hiker");
      add("Bandana", "Protects against some heat-related effects", null, "Lifeguard");
      add("Belt Pack", "Provides 2 extra equipment slots.", null, "MacGyver");
      add("Binoculars", "+1 on any move roll 4 or higher.", null, "Search and Rescue");
      ...
      add("CITO Bag", "You may discard this card to gain 2 points.", "CITO", "Naturalist");
      add("Compass", "Can prevent the effects of getting lost.", null, "Eagle Scout");
      ...
      add("External Antenna", "Add 1 to your Search roll in Forest and Urban tiles.", "Antenna", "Engineer");
      add("Extra Batteries", "You may reroll if both dice are 0", "Batteries", "Eagle Scout");
      add("Field Guide", "You may discard to solve any puzzle cache.", null, "Naturalist");
      ...
      add("FRS Radio", "If you roll <em class=find>FIND</em>, you may jump to any tile occupied by another player.", null, "Search and Rescue");
      ...
      add("Insect Repellent", "Can prevent several bug-related events.", "BugSpray", "Night Cacher");
      add("Laptop", "You may solve any Puzzle cache using only 1 of the letters.", null, "Engineer");
      add("Letterbox Stamp", "+1 point whenever you find a level 3 cache.", null, "Event Coordinator");
      ...
      add("Lucky Charm", "You get +1 whenever you roll doubles.", null, "Hitchhiker");
      add("Map", "Can prevent the effects of getting lost.", null, "Tracker");
      add("Mirror", "+1 on Search rolls for caches in Urban areas.", null, "Photographer");
      ...
      add("Rope", "No other player may play Events on you if you are in Rocky terrain.", null, "Paramedic");
      add("Safari Vest", "Provides 3 extra equipment slots.", null, "Photographer");
      add("Survival Strap", "You may reroll if both dice are 1.", null, "Hitchhiker");
      add("Swag Bag", "Provides 2 extra equipment slots.", null, "Hitchhiker");
      add("Trail Guide", "You may move 1 extra tile along a path each turn.", null, "Through Hiker");
      add("Utility Tool", "+1 on Search rolls for all Multi-caches.", null, "MacGyver");
      add("Waders", "Crossing a stream only costs you 1 movement point.", null, "Tracker");
      ...
      add("Whistle", "Good for clearing the pool, too.", null, "Lifeguard");
      add("Yellow Jeep", "+1 on Move rolls on Urban and Clear tiles.", null, "Search and Rescue");

      /*
       * // OBSOLETE add ("Coat", "Protects against some cold-related effects", null, "Insulation"); add (
       * "Emergency Blanket", "Discard to ignore any weather-related effect.", null, "Just In Case"); add (
       * "Metal Detector", "Provides a 50/50 chance to prevent effects that would cause you to lose an Equipment card.",
       * null, ""); add ("Sunscreen", "Protects against some sun-related effects", null, ""); add ("PDA",
       * "You may roll again if your first Search roll fails.", null, "Engineer"); add ("Umbrella",
       * "Protects against some rain-related effects.", null, "");
       */
   }
   ...
   // page width ~ 600
   private static final int Width = 150; // 180;
   private static final int PictureH = 85; // 120;
   ...
   private static void printCard(final PrintWriter out, final Equipment eq, final int i)
   {
      ...
      out.println("  <tr><td align=center bgcolor=" + COLOR + "><b>" + eq.name + "</b></td></tr>");
      ...
      out.println("  <tr><td align=center height=" + TextH + " width=" + Width + ">" + eq.text + "</td></tr>");
