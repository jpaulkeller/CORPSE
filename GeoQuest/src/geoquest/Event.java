...
public class Event extends Card implements Comparable<Event>
{
   ...
   {
      add ("All About the Numbers", Type.STD, 0, "Jump to the nearest level <em class=diff1>-1-</em> cache you have not yet found.  End your turn unless", "Numbers", null, "Jeep", "Mountain Bike");
      ...
      // TODO skip? remain until roll 3?
      add ("Broken Wrist", Type.STD, 0, " Jump your token to the Hospital.  End your turn, and skip your next turn.  Lose 4 points if you play this card on another player.", null, "Move Hospital", "[First-aid Kit]");
      ...
      add ("Flash Flood", Type.STD, 0, "Remove the nearest cache that is next to a stream from the board.  End your turn.", null, null, "Waders");
      ...
      add ("Ground Zero", Type.ANY, 0, "You may jump your token to the nearest cache location.", null, "Move Cache");
      ...
      add ("Helpful Hint", Type.ANY, 0, "You may discard this card to get +2 on your roll.", null, "Roll +2");
      add ("Hidden Path", Type.ANY, 0, "You find a hidden path.  Double your Move roll this turn.", null, "Move x2");
      add ("In a Hurry", Type.STD, 0, "You may move an additional 2 tiles this turn.  Lose 1 point unless", null, "Move 2", "Letterbox Stamp");
      ...
      add ("Lost Travel Bug", Type.STD, 0, "Discard a <em class=bug>Travel Bug</em>.  Lose 3 points.  Ignore this card if you don't have a <em class=bug>Travel Bug</em>.", null, "Point -3", "Belt Pack");
      ...
      add ("Mud Slide", Type.STD, 0, "End your turn.  Discard one of your Equipment cards unless", null, "Equip -1", "Survival Strap");
      add ("Muggled!", Type.STD, 0, "The nearest level .1- or -2 cache has been emptied.  Remove any <em class=bug>Travel Bugs</em> it has.  It may still be found, but finders don't get to draw Equipment cards.", null, null);
      add ("Night Caching", Type.STD, 0, "All players not on an Urban tile skip their next turn.", null, null, "Flashlight", "Head Lamp");
      add ("Not About the Numbers", Type.STD, 0, "Gain one point for each level <em class=diff5>5-</em> cache you have found.  If none, lose 2 points unless", null, null, "Binoculars", "Rope");
      ...
      add ("Perfect Pair", Type.STD, 0, "You may discard one Equipment card to select any other one you want from the deck.", null, null);
      add ("Point of Interest", Type.STD, 0, "End your turn.  Gain 2 points (3 if you have the <em class=equipment>Binoculars</em> or <em class=equipment>Camera</em>).", "Scenic View", "Point +2", "[Binoculars]", "[Camera]");
      // TODO skip?
      add ("Poison Ivy", Type.STD, 0, "After finding your next cache, jump your token to your starting tile, and skip a turn.", null, "Move Start", "Gloves", "Field Guide");
      ...
      add ("Rare Bird", Type.STD, 0, "You spot an ivory-billed woodpecker.  Gain 2 points (4 if you have the <em class=equipment>Camera</em>).", null, "Point +2");
      ...
      // TODO art
      add ("Sloppy Hide", Type.NOW, -2, "From now on, all Search rolls for the last cache you found get +1.", null, "Point -2", "Mirror");
      ...
      add ("Stick Race", Type.STD, 1, "Jump your token to the nearest bridge, and end your turn.", "Pooh Sticks", "Move Bridge");
      add ("Stop For Directions", Type.STD, 0, "End your turn, but get +3 to your next Move roll.", null, "Move 3", "Cell Phone", "Map");
      add ("Suspicious Activity", Type.STD, 0, "End your turn.  Roll the dice: if you roll a <em class=dnf>.D.</em>, jump to the Police tile.", "Police", "Move Police", "Backpack", "CITO Bag");
      // TODO improve
      add ("There's the Path!", Type.STD, 0, "You stumble upon the path you should have taken. You get -1 on this roll, but +2 on your next roll.", "Path", "Move -1", "Trail Guide");
      ...
      add ("Upgrade", Type.STD, 1, "Draw an Equipment card, then give any one Equipment card you have to the another player with the fewest equipment cards.", null, "Point +1");
      ...
      add ("Winter is Coming", Type.STD, 0, "Sometimes it's just too cold for caching.  End your turn, and jump your token back to your starting location.", null, "Move Start", "Emergency Radio");
      ...
      // add ("Cache Maintenance", Type.STD, 0, "The cache nearest to you needs maintenance.  The player on your right moves the cache 1 tile in any direction.", null, null);
      ...
      // add ("No Trespassing", EventType.STD, -1, "The player on your right moves your token 1 tile in any direction.", null, null, "Trail Guide");
