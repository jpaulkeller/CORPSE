...
public class Combo implements Card, Comparable<Combo>
{
   ...
   {
      add("Eagle Scout", "Compass", "Extra Batteries", "Pocket Knife", "When an event would affect you, ",
         "you may discard any Equipment card to ignore it.");
      add("Engineer", "Cell Phone", "External Antenna", "Laptop", "Whenever another player rolls a <em class=find>FIND</em>, ",
      ...
      add("Paramedic", "First-aid Kit", "Repair Kit", "Rope", "If an Event card would award you points, ",
      ...
      add("Weatherman", "Emergency Radio", "Gloves", "Waterproof Jacket", "",
