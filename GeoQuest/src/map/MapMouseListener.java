...
public class MapMouseListener extends MouseAdapter
{
   ...
   public void mouseReleased(final MouseEvent e)
   {
      if (e.isPopupTrigger())
      {
         System.out.println("MapPanel popup release"); // TODO
      ...
      else
      {
         ...
         if (view.getMode().usesBox() && view.getAnchor() != null)
         {
            ...
            else if (view.getMode() == Mode.Erase && !view.getAnchor().equals(view.getCursorPoint()))
      ...
      else
      {
         ...
         else if (mode.usesLine())
         {
            if (view.getAnchor() != null && !view.getAnchor().equals(cursor))
               model.addLine(new Line(mode.getLineType(), model.getScale(), view.getAnchor(), cursor));
