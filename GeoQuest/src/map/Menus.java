...
public class Menus
{
   ...
   private JMenu makeViewMenu()
   {
      ...
      menu.add (makeCheckItem (SCALE_1, KeyEvent.VK_1, "ScaleFull.gif", true, scales, "Show map at full scale"));
      menu.add (makeCheckItem (SCALE_2, KeyEvent.VK_2, "ScaleHalf.gif", false, scales, "Show map at 1/2 scale"));
      menu.add (makeCheckItem (SCALE_4, KeyEvent.VK_4, "ScaleQuarter.gif", false, scales, "Show map at 1/4 scale"));
   ...
   private JToolBar makeTools()
   {
      ...
      ButtonGroup scales = new ButtonGroup();
      tools.add (makeToggle (SCALE_1, "ScaleFull.gif", true, scales, "Show map at full scale"));
      tools.add (makeToggle (SCALE_2, "ScaleHalf.gif", false, scales, "Show map at 1/2 scale"));
      tools.addSeparator();
   ...
   private JMenuItem makeMenuItem (final String label, final int mnemonic,
   ...
   private JCheckBoxMenuItem makeCheckItem (final String label, final int mnemonic,
   ...
   private JToggleButton makeToggle (final String command, final String iconName, final boolean on, 
                                     final ButtonGroup group, final String tip)
   {
      ImageIcon icon = ImageTools.getIcon ("icons/buttons/" + iconName);
