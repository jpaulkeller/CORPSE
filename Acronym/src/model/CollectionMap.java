 ...
 * The putElement and removeElement methods have been provided to support 
...
public class CollectionMap<K, V> extends TreeMap<K, List<V>>
{
   ...
   {
      CollectionMap<String, String> cm = new CollectionMap<String, String>();
      System.out.println ("\nAdding elements...");
      cm.putElement ("dog", "collie");
      cm.putElement ("dog", "doberman");
      cm.putElement ("dog", "spaniel");
      cm.putElement ("cat", "persian");
      cm.putElement ("cat", "cheshire");
      System.out.println (cm.toString (true));

      System.out.println ("\nRemoving elements...");
      cm.removeElement ("dog", "spaniel");
      cm.removeElement ("cat", "persian");
      cm.removeElement ("cat", "cheshire");
      System.out.println (cm.toString (true));
   }
}
