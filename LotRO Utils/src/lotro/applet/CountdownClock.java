...
public class CountdownClock extends Applet implements Runnable
{
   ...
   private String label = "Loading..."; // displayed to user
   ...
   public String[][] getParameterInfo()
   {
      String[][] info =
      { 
         { PARAM_DATE, "String", "Date/time to which applet will countdown" },
      };
      return info;
   }
   ...
   private static String decode (final String urlArg)
   {
      try
      {
   ...
   private String getLabel()
   {
      ...
      if (targetDate.after (currentDate))
      {
         ...
         label = "Countdown reached: " + paramDate;
      return label;
   }
