...
public class Equipment implements Card, Comparable<Equipment>
{
   ...
   {
      add ("Backpack", "Provides 4 extra slots, but you can't move more than 5 each turn.", null, "Through Hiker");
      add ("Belt Pack", "Provides 2 extra slots.", null, "Hitchhiker");
      ...
      add ("Hydration Pack", "Provides 2 extra slots.", "HydrationPack", "Road Warrior");
      ...
      add ("Safari Vest", "Provides 3 extra slots.", null, "Photographer");
      add ("Swag Bag", "Provides 2 extra slots.", null, "Naturalist");
      ...
      add ("Waterproof Jacket", "Provides 1 extra slot.", "GoreTex", "Weatherman");
