...
public class HeatMapDemo extends JFrame implements ItemListener, FocusListener
{
   ...
   private JCheckBox drawLegend;
   private JCheckBox drawTitle;
   private JCheckBox drawXTitle;
   private JCheckBox drawXTicks;
   private JCheckBox drawYTitle;
   private JCheckBox drawYTicks;
   ...
   {
      "GRADIENT_BLACK_TO_WHITE", "GRADIENT_BLUE_TO_RED",
      "GRADIENT_GREEN_YELLOW_ORANGE_RED", "GRADIENT_HEAT", "GRADIENT_HOT",
      "GRADIENT_RAINBOW", "GRADIENT_RED_TO_GREEN"
   };
   private Color[][] gradients =
   {
      Gradient.BLACK_TO_WHITE, Gradient.BLUE_TO_RED,
      Gradient.GREEN_YELLOW_ORANGE_RED, Gradient.HEAT, Gradient.HOT,
      Gradient.RAINBOW, Gradient.RED_TO_GREEN
   };
   ...
   public HeatMapDemo() throws Exception
   {
      ...
      double[][] data = HeatMap.generateSinCosData (201);

      // you can use a pre-defined gradient:
      panel = new HeatMap (data, Gradient.BLACK_TO_WHITE);
   ...
   private Color colorFromHex (final String c)
   {
      try
      {
