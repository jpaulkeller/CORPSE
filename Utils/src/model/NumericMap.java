...
public class NumericMap<K, V extends Number> extends TreeMap<K, V>
{
   ...
   public NumericMap (final Class<V> numericType)
   {
      this.numericType = numericType;
      this.arithmeticType = ArithmeticType.forClass (numericType);
   }
   
   public NumericMap (final Class<V> numericType, final Map<K, V> map)
   {
      this (numericType);
      putAll (map);
   }
