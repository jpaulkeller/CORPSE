...
function command:GetHelp()
   Turbine.Shell.WriteLine("<rgb=#00FFFF>FM Helper (version " .. Plugins.FMHelper:GetVersion() .. ")</rgb> by Mosby of Landroval");
   Turbine.Shell.WriteLine("Usage: /fmh [show|hide|toggle]");
end

Turbine.Shell.AddCommand("fmh", command);
command:GetHelp();
