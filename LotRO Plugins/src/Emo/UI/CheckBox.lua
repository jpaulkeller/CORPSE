...
function CheckBox:Constructor()
    ...
    self.check:SetBackground("FrelledPlugins/Emo/UI/Resources/checkbox_02_empty.tga");
...
function CheckBox:UpdateState()
    ...
    if (self.checked) then
        self.check:SetBackground("FrelledPlugins/Emo/UI/Resources/checkbox_02"..(enabled and "" or "_ghosted")..".tga");
    else
        self.check:SetBackground("FrelledPlugins/Emo/UI/Resources/checkbox_02_empty"..(enabled and "" or "_ghosted")..".tga");
    end
end
