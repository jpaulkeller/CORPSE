import "Palantiri.GambitGuide.GUI";
import "Turbine";
...
function command:GetHelp()
   Turbine.Shell.WriteLine("<rgb=#00FFFF>Gambit Guide (version " .. Plugins.GambitGuide:GetVersion() .. ")</rgb> by Mosby of Landroval");
   Turbine.Shell.WriteLine("Usage: /gg [show|hide|toggle]");
end

Turbine.Shell.AddCommand("gg", command);
command:GetHelp();
