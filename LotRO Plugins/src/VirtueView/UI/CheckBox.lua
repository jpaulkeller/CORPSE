...
function CheckBox:Constructor()
    ...
    self.check:SetBackground("Palantiri/VirtueView/Resources/checkbox_02_empty.tga");
...
function CheckBox:UpdateState()
   ...
   if (self.checked) then
       ...
       self.check:SetBackground("Palantiri/VirtueView/Resources/checkbox_02"..(enabled and "" or "_ghosted")..".tga");
   else
       self.label:SetForeColor(standardText);
       self.check:SetBackground("Palantiri/VirtueView/Resources/checkbox_02_empty"..(enabled and "" or "_ghosted")..".tga");
   end
end
